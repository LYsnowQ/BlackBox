...
- 2026-07-26 · 底栏发布加号再放大 3px · 内层 28→31，字号 17→18
- 2026-07-26 · 底栏发布加号略放大 · 内层 24→28，字号 16→17
- 2026-07-26 · 修复发布加号被 layoutWeight 横向拉伸 · 外层均分占位、内层固定正方形 + constraintSize
- 2026-07-26 · 底栏中间发布加号继续收窄 · `Index.ets` 按钮 29→24 正方形，字号 18→16
- 2026-07-26 · 底栏中间发布加号再收窄 · `Index.ets` 按钮 32→29（宽高），贴合导航比例
- 2026-07-26 · 底栏中间发布加号样式收敛 · `Index.ets` 由 44×44/圆角12/字号20 调整为 32×32/圆角8/字号18，贴合其它 Tab 视觉比例（仅样式）
